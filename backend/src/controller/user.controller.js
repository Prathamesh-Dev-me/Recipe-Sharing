...
export const Register = asyncHandler(async (req, res) => {
    ...
    const { url, public_id } = await uploadOnCloudinary(profileLocalPath);
    ...
    const newUser = await User.create({ username, email, password, img: { url, public_id } });
...
export const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        const { accessToken, newRefreshToken } = await generateAccessTokenAndGenerateRefreshTokens(user._id);
